										...
										<ul className="ps-3">
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													<p className="text-300 text-nowrap fw-regular mb-0">2011 - 2013:</p>
													<div>
														<span className="text-primary-2">University Of Sunderland</span>
														<p className="text-dark">Bachelor’s Degree in Network Computing</p>
													</div>
												</div>
											</li>
											<li className="position-relative z-1 mb-3">
												<div className="d-flex gap-2">
													...
													<div>
														<span className="text-primary-2">British Computer Society</span>
														<p className="text-dark">Diploma: Computer Science</p>
													</div>
												</div>
											</li>
										</ul>
						...
						<div className="col-lg-6 pt-3">
							<div className="bg-3 rounded-3 border border-1 p-md-6 p-3 position-relative h-100 overflow-hidden">
								<div className="d-flex align-items-center">
									...
									<h2 className="mb-0 ms-2">Key Achievement</h2>
								</div>
								<div className="d-flex flex-column h-100 position-relative mt-5">
									<ul className="ps-3">
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">GitOps Implementation</span>
													<p className="text-dark">Directed the migration of the organization's infrastructure and deployment processes to a fully GitOps-enabled environment.</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">Payment Settlement Engine</span>
													<p className="text-dark">Developed an engine to facilitate, process, and settle financial transactions between parties, such as individuals, businesses, or financial institutions across various timezone</p>
												</div>
											</div>
										</li>
										<li className="position-relative z-1 mb-3">
											<div className="d-flex gap-2">
												...
												<div>
													<span className="text-primary-2">USSD Payment Channel</span>
													<p className="text-dark">Worked with other engineers in the migration of a critical financial service which processes the most financial transactions in the bank.</p>
												</div>
											</div>
										</li>
									</ul>
