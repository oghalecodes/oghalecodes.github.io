...
export default function Home() {
	const icons = Array.from({ length: 37 }, (_, i) => `/assets/imgs/home-page-2/hero-1/icon-${i+1}.svg`)
	return (
		<>
							...
							<div className="row align-items-end py-60">
								...
								<div className="col-lg-6 mx-lg-auto col-md-12">
									<div className="p-lg-0 p-md-8 p-3">
										...
										<h1 className="fs-50 my-3">Senior <span className="text-linear-4">{'{'}Full Stack{'}'}</span> Software Engineer<span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;
											<span className="text-dark">With deep expertise across various industry such as </span> 
											<span className="text-dark">FinTech, Insurance, Risk Analysis and Integrity, Ecommerce ... </span> 
											<span className="text-dark">I leverage </span> 
											<span className="text-secondary-2">C# &amp; .NET Core</span>, 
											<span className="text-secondary-2"> JavaScript/TypeScript</span>, 
											<span className="text-secondary-2"> Python</span>,  
											<span className="text-secondary-2"> React</span> and
											<span className="text-secondary-2"> Go</span>
											<span className="text-dark">... I deliver scalable, secure, and high-performance web solutions that drive business impact and delight users..</span>&lt;/p&gt;
										</p>
										<div className="row">
											<div className="col-7">
												{/* Carousel Scroll */}
