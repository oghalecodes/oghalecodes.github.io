						...
						<nav className="navbar navbar-expand-lg navbar-home-2 flex-nowrap z-999 p-0 border border-1 rounded-3">
							...
							<div className="container py-3 px-4">
								<Link className="navbar-brand d-flex main-logo align-items-center" href="/">
									<img src="assets/imgs/home-page-2/template/favicon.svg" alt="iamoghale" />
								...
								<div className="navbar-social d-flex align-items-center pe-5 pe-lg-0 me-5 me-lg-0">
									<div className="d-md-flex d-none gap-3">
										<Link href="https://medium.com/@oghalecodes"	target="_blank">
											<i className="ri-medium-fill fs-18" />
										</Link>
										<Link href="https://www.instagram.com/oghale_codes" target="_blank">
											<i className="ri-instagram-fill fs-18" />
										</Link>
										<Link href="https://linkedin.com/in/iamoghale" target="_blank">
											<i className="ri-linkedin-fill fs-18" />
										</Link>
										<Link href="https://github.com/oghalecodes" target="_blank">
